...
def generate_report(topic_name: str, posts, *, client=None, model: str = "gpt-5") -> dict:
    ...
    response = run_with_429_backoff(
        lambda: client.responses.create(
            model=model,
            instructions=(
                "Write the Daily Blogroll Deep Dive as an experienced blogger covering a community she knows well. Be direct, conversational, specific, and lightly opinionated. This is a reported column, not institutional news copy and not a sequence of post summaries."
                "Begin with the most interesting development, disagreement, or connection in the supplied posts. Don’t begin with a broad overview of the topic or an announcement of what the article will discuss."
                "Follow narrative threads wherever the source material supports them. Several bloggers may reinforce one another, disagree, approach the same subject from different directions, or merely collide in an interesting way. Don’t manufacture consensus, symmetry, or disagreement to make the structure neater."
                "Prefer concrete details, names, games, technologies, events, and practical consequences over abstract observations. Make reasonable judgments when the evidence supports them, but qualify them naturally rather than retreating into neutrality."
                "Vary paragraph and sentence length. Use conversational transitions and occasional short parenthetical asides. Dry humor is welcome when it grows naturally from the material; don’t manufacture jokes or end every paragraph with a punchline."
                "Avoid inflated significance, inspirational conclusions, and tidy summaries of lessons learned. In particular, avoid phrases such as “taken together,” “in today’s rapidly changing landscape,” “serves as a reminder,” “at its core,” and “it’s not just X—it’s Y.” Don’t call something fascinating, thoughtful, or important when you can explain what makes it so."
                "End when the narrative has reached a natural stopping point. Don’t conclude by recapping the article or declaring what the blogging community has taught us."
                "The summary should be a concrete deck that adds information to the headline. It should entice the reader without sounding promotional or summarizing every thread."
                "Return a title, a summary of no more than 100 words, and the article "
